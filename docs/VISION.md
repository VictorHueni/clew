...
_TODO_ — no downstream artefacts minted yet. Personas (P-NN), objectives (OBJ-NN), and value propositions (VP-NN) will be linked here as the metamodel is populated.
...
- 2026-05-24 · Broaden · Scope made explicit: business architecture, market intelligence, product specs, domain, and requirements — one connected metamodel, not RM alone.
