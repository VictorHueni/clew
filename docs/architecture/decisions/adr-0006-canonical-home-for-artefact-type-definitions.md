...
- Document the two-layer choice in this ADR and queue the kit-side changes as `OI-0024` / `OI-0025`.
...
- This ADR's `OI-0024` (registry file creation) closes with a `Tracker ref` pointing at the kit PR.
...
| :----- | :------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------- | :---------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------- | :----- | :----------- | :---------------- | :---------- |
| OI-0024 | doc-gap        | Create `homemade-claude-kit/rules/artefact-types-registry.md` with the canonical table per the Phase 2 column shape proposed in §Decision Outcome. Backfill all current artefact types from `rules/metamodel.md` + `ARTEFACT_TYPE_CONFIGS` sources.                | #decision-outcome            | Decision Outcome — Phase 2                                  | Open a kit-side PR creating the file with full backfill in one pass. Phase 2 closes when the file is on `main`.                                                                                                                                  | high     | in-progress   | Victor Hueni | 2026-07-15        | [kit PR #45](https://github.com/VictorHueni/homemade-claude-kit/pull/45) (closes on merge to main)       |
