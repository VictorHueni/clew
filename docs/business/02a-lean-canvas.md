...
- **For PR-1 (silent failure).** Write-time integrity enforcement, so a violation surfaces at the moment it is introduced ([OBJ-02 KR-02.2](04b-objectives.md#obj-02--the-architectural-substrate-is-trustworthy-enough-that-agents-depend-on-it)) rather than weeks later when a downstream reader notices. First concrete demo: [ADR-0002 artefact-to-file binding](../architecture/decisions/adr-0002-artefact-file-binding.md).
