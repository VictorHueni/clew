...
**Upstream gaps:** processes (`proc-NN-{slug}`), FBS functionalities, and quantitative models are not yet defined; soft-link slots referencing them remain `_TODO_`. Value streams are defined in [`04a-value-streams.md`](04a-value-streams.md): VS-1 (Compose Architecture) is fully filled; VS-2 (Navigate), VS-3 (Refactor), and VS-4 (Share) are catalogued but not yet stage-decomposed. §3 UVP and §5 Channels soft-links reference VS-1 directly; bullets that depend on VS-2 / VS-3 / VS-4 stages are flagged as queued. Capabilities are defined in [`03a-capability-map.md`](03a-capability-map.md); §4 and §9 soft-links reference them directly.
...
- **Soft-link gaps:** FBS-_TODO_, Quantitative model _TODO_, Cost model _TODO_, VPC-_TODO_. These wire up as the metamodel fills out. (Capabilities wired 2026-05-24, see [03a-capability-map.md](03a-capability-map.md). Value streams wired 2026-05-25, see [04a-value-streams.md](04a-value-streams.md): VS-1 filled, VS-2/3/4 catalogued. §3 UVP and §5 Channels reference VS-1 directly; bullets that depend on VS-2 / VS-3 / VS-4 stages remain partially queued. A separate "Adopt clew" acquisition value stream would be needed to fully wire §5 Channels Discovery/Support phases; not modelled today because the prospective-P-01 persona does not yet exist.)
