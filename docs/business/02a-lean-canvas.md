...
**Upstream gaps:** value streams (`VS-N.M`), processes (`proc-NN-{slug}`), FBS functionalities, and quantitative models are not yet defined. Soft-link slots referencing them are marked `_TODO_` and should be wired when those artefacts land. Capabilities are now defined in [`03a-capability-map.md`](03a-capability-map.md); §4 and §9 soft-links below reference them directly.
...
- **Soft-link gaps:** VS-_TODO_, FBS-_TODO_, Quantitative model _TODO_, Cost model _TODO_, VPC-_TODO_. These wire up as the metamodel fills out. (Capabilities: wired 2026-05-24, see [03a-capability-map.md](03a-capability-map.md).)
