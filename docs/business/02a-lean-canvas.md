...
**Soft-links:** [VS-1 Compose Architecture](04a-value-streams.md#vs-1--compose-architecture) (filled; the substrate that delivers Concrete win 3 and the foundational methodology distillation; VS-1.3 Draft + VS-1.4 Persist realise it stage-by-stage). [VS-2 Navigate Architecture](04a-value-streams.md#catalogue) (catalogued; will realise Concrete win 1 once filled: the "< 30 s cross-artefact answer" promise). [VS-3 Refactor Architecture](04a-value-streams.md#catalogue) (catalogued; will realise Concrete win 2 once filled: the "rename catches drift at write-time" promise; partially already realised at VS-1.4 via write-time integrity). [VS-4 Share Architecture](04a-value-streams.md#catalogue) (catalogued; will realise the markdown-and-git readability promise once filled). The Bidirectional time traceability bullet cross-cuts; it is partially realised at VS-1.4 (audit trail) and fully realised once VS-2 (Navigate) is filled. (VPC-_TODO_ deferred: wave 1 produced strong value-fit signal directly; VPC drill-down belongs after external interviews.)
